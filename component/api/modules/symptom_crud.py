...
from component.models import Symptom
from component.api.serializers import SymptomSerializer
...
def get_all(request):
	user = request.user
	try:
		symptom = Symptom.objects.filter(user=user)
