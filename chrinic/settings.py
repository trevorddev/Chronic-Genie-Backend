"""
Django settings for chrinic project.
...
ALLOWED_HOSTS = ["18.144.64.5", "127.0.0.1", "localhost"]
...
WSGI_APPLICATION = 'chrinic.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [ os.path.join(BASE_DIR, 'static'),os.path.join(BASE_DIR, 'game/static'),]
